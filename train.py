...
parser.add_argument("--network_config", default="ECGCNN_M", type=str,
                    choices=["ECGCNN_S", "ECGCNN_M", "ECGCNN_L", "ECGCNN_XL", "ECGAttNet_S", "ECGAttNet_M",
                             "ECGAttNet_L", "ECGAttNet_XL", "ECGAttNet_XXL", "ECGAttNet_130M", "ECGCNN_SE"],
...
if __name__ == '__main__':
    ...
    elif args.network_config == "ECGCNN_SE":
        config = ECGCNN_SE_CONFIG
        data_logger = Logger(experiment_path_extension="ECGCNN_SE" + dataset_info)
        print("ECGCNN_SE utilized")
